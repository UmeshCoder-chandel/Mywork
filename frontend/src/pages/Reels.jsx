    ...
    <div className="relative w-full h-[100svh] bg-black flex items-center justify-center">
      ...
      {showHeart && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <FaHeart className="text-red-500 text-6xl opacity-90 animate-bounce" />
        </div>
      )}
      ...
      <div className="absolute right-4 bottom-24 flex flex-col items-center gap-6 text-white">
        ...
        <button onClick={() => setMuted(!muted)} className="w-10 h-10 rounded-full bg-black/40 flex items-center justify-center border border-white/20">
          {muted ? (
...
const Reels = () => {
  ...
  return (
    <div className="relative w-full h-[100svh] bg-black">
      ...
      >
        {reels.map((reel, index) => (
          <div key={reel._id} className="w-full h-[100svh] snap-start flex-shrink-0">
